...
export function getLiturgicalDay(dateStr: string): LiturgicalDay {
    ...
    const fixedFeasts: any = {
        ...
        '3-19': { title: 'St. Joseph, Spouse of the Blessed Virgin Mary', type: 'Solemnity', color: 'white', key: 'SaintJoseph' },
        '3-25': { title: 'Annunciation of the Lord', type: 'Solemnity', color: 'white', key: 'AnnunciationOfTheLord' },
        '6-24': { title: 'Nativity of St. John the Baptist', type: 'Solemnity', color: 'white', key: 'NativityOfSaintJohnTheBaptist' },
        '6-29': { title: 'Sts. Peter and Paul, Apostles', type: 'Solemnity', color: 'red', key: 'SaintsPeterAndPaulApostles' },
        '8-6': { title: 'Transfiguration of the Lord', type: 'Feast', color: 'white', key: 'TransfigurationOfTheLord' },
        ...
        '12-25': { title: 'The Nativity of the Lord (Christmas)', type: 'Solemnity', color: 'white', key: 'NativityOfTheLord_Christmas' },
        '12-26': { title: 'St. Stephen, First Martyr', type: 'Feast', color: 'red', key: 'SaintStephen' },
        '12-27': { title: 'St. John, Apostle and Evangelist', type: 'Feast', color: 'white', key: 'SaintJohnApostle' },
